...
const PersonalYogaClassForm = ({ formType }) => {
  const FORM_CONFIG = {
    "group-yoga": {
  ...
  const config = FORM_CONFIG[formType] || FORM_CONFIG["personal-yoga"];
...
PersonalYogaClassForm.propTypes = {
...
export default PersonalYogaClassForm;
